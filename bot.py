...
# ------------------ BOT AYARLARI ------------------
DISCORD_TOKEN = os.getenv("DISCORD_TOKEN")  # Render ortam değişkeninden token alınacak
...
async def on_ready():
    ...
    # Test kanalı ID'sini kendi sunucuna göre değiştir
...
async def sil(ctx, miktar: int):
    if miktar < 1:
        await ctx.send("Lütfen 1 veya daha fazla mesaj silmek için bir sayı gir.")
        return
